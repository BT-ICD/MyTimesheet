...
namespace MyTimesheetAPI.Controllers.Master
{
    ...
    public class TeamMemberController : ControllerBase
    {
        ...
        public TeamMemberController(ITeamMemberRepository teamMemberRepository, IMapper mapper, ILogger<TeamMemberController> logger, IDesignationRepository designationRepository)
        {
        ...
        public async Task<IActionResult> GetTeamMemberById(int teamMemberId)
        {
            try
            {
                ...
                var response = mapper.Map<TeamMemberEditDTO>(result);
        ...
        [HttpPost]
        [ProducesResponseType(StatusCodes.Status200OK)]
        public async Task<IActionResult> InsertTeamMember(TeamMemberAddDTO teamMemberAdd)
        {
        ...
        [ProducesResponseType(StatusCodes.Status200OK)]
        [ProducesResponseType(StatusCodes.Status404NotFound)]
        public async Task<IActionResult> UpdateTeamMember(TeamMemberEditDTO teamMemberEdit)
        {
            try
            {
